...
const gridOptions: VxeGridProps<StationAlarmItem> = {
  ...
  columns: [
    ...
    { field: 'label', title: '工位名称', width: 150 },
    { field: 'code', title: '工位代号', width: 120 },
    { field: 'processId', title: '工序ID', width: 100 },
    { field: 'type', title: '类型', width: 80 },
    { field: 'alarmA', title: '报警A', width: 100 },
    { field: 'alarmB', title: '报警B', width: 100 },
    { field: 'alarmC', title: '报警C', width: 100 },
    {
      field: 'inputTime',
      formatter: ({ cellValue }) => {
