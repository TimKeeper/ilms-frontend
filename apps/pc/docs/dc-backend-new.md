...
原始数据预览接口，且仅能够浏览最多100页。
因数据量巨大，无法使用传统分页手段。
首次查询必定是第一页，且会返回下一页的游标cursor。
用户交互时，只能点击上一页和下一页，前端需要记录当前筛选条件下和页大小的游标信息，方便点击上一页时可以直接找到对应的游标。
若用户修改了筛选条件以及页大小，则重新从第一页开始。
注意：
1、前端限制最多翻页100页，再多影响性能。
2、后端接口若没返回cursor，说明肯定不存在下一页。
3、后端接口若返回了cursor，不一定说明肯定存在下一页，若传入cursor后继续查询返回的为空，则提示用户已经是最后一页。
...
|» resMsg|string|true|none||none|
|» data|object|false|none||none|
|»» cursor|number|false|none|下一页游标|不返回说明没有下一页，但返回了也可能没有下一页|
|»» items|[object]|true|none||none|
...
GET /api/tag/v1/bind-failed/list
...
|名称|位置|类型|必选|中文名|说明|
|---|---|---|---|---|---|
|frameName|query|string| 否 ||车架名称-精确匹配|
|ironName|query|string| 否 ||铁包名称-精确匹配|
|stationLabel|query|string| 否 ||工位名称-精确匹配|
|page|query|integer| 是 ||none|
|pageSize|query|integer| 是 ||none|
|token|header|string| 否 ||none|
    ...
    "items": [
      {
        ...
        "stationLabel": "工位 2",
        "frameName": "mock车架1",
        "preFrameTagSn": 7182548,
        "preFrameTagStartTime": 1770539075000,
        "preFrameTagEndTime": 1770539095000,
        "failType": 4,
        "bindingFailedTime": 1770539095000
      },
      {
        "id": 1,
        "stationLabel": "工位 1",
        "frameName": "mock车架1",
        "preFrameTagSn": 7182548,
        "preFrameTagStartTime": 1770539074000,
        "preFrameTagEndTime": 1770539084000,
        "failType": 4,
        "bindingFailedTime": 1770539084000
      }
    ]
  }
}
...
|»»» id|integer|true|none||none|
|»»» stationLabel|string|true|none|工位名称|none|
|»»» frameName|string|false|none|车架名称|none|
|»»» preFrameTagSn|number|false|none|车架首次读取到的标签SN|车架前标签|
|»»» preFrameTagStartTime|number|false|none|读取到前标签的开始时间|精确到毫秒|
|»»» preFrameTagEndTime|number|false|none|读取到前标签的结束时间|精确到毫秒|
|»»» postFrameTagSn|number|false|none|车架末次读取到的标签SN|车架后标签|
|»»» postFrameTagStartTime|number|true|none|读取到后标签的开始时间|精确到毫秒|
|»»» postFrameTagEndTime|number|true|none|读取到后标签的结束时间|精确到毫秒|
|»»» ironName|string|false|none|铁包名称|none|
|»»» ironTagSn|number|false|none|铁包标签SN|none|
|»»» ironTagStartTime|number|true|none|读取到高温标签的开始时间|精确到毫秒|
|»»» ironTagEndTime|number|true|none|读取到高温标签的结束时间|精确到毫秒|
|»»» failType|integer|true|none|绑定失败类型|异常类型，具体描述参考描述信息|
|»»» bindingFailedTime|number|true|none|绑定失败时间|精确到毫秒|
...
|»»» progress|string|false|none|进度百分比|none|
    ...
    "radarList": [
      {
        ...
        "radarPort": 5005,
        "radarAddress": 1,
        "radarAntenna1StationId": 2,
        "radarAntenna1StationLabel": "工位 2",
        "radarAntenna1StationCode": "2",
        "radarAntenna1ProcessOrder": 2,
        "radarAntenna2StationId": 3,
        "radarAntenna2StationLabel": "工位 3",
        "radarAntenna2StationCode": "3",
        "radarAntenna2ProcessOrder": 3,
        "radarStatus": 1,
        "inputTime": 1769345644000,
        "updateTime": 1769345644000,
        "station": "default"
      }
    ]
  }
...
|» resMsg|string|true|none||none|
|» data|object|true|none||none|
|»» radarList|[object]|true|none||none|
|»»» id|integer|false|none|雷达id|none|
|»»» radarHost|string|false|none|雷达ip|none|
|»»» radarPort|integer|false|none|雷达端口|none|
|»»» radarAddress|integer|false|none|雷达地址|none|
|»»» radarAntenna1StationId|integer|false|none|雷达天线1工位id|none|
|»»» radarAntenna1StationLabel|string|false|none|雷达天线1工位名称|none|
|»»» radarAntenna1StationCode|string|false|none|雷达天线1工位代号|none|
|»»» radarAntenna1ProcessOrder|integer|false|none|雷达天线1工位工序|none|
|»»» radarAntenna2StationId|integer|false|none|雷达天线2工位id|none|
|»»» radarAntenna2StationLabel|string|false|none|雷达天线2工位名称|none|
|»»» radarAntenna2StationCode|string|false|none|雷达天线2工位代号|none|
|»»» radarAntenna2ProcessOrder|integer|false|none|雷达天线2工位工序|none|
|»»» radarStatus|integer|false|none|雷达当前状态|none|
|»»» inputTime|integer|false|none||none|
|»»» updateTime|integer|false|none||none|
|»»» station|string|false|none|oracle数据库同步使用|忽略该字段|
